...
let s:gui_green = '#82c78f'
let s:cterm_green = 121
let s:gui_blue = '#8fbfdc'
let s:cterm_blue = 117
let s:gui_purple = '#c7b6db'
let s:cterm_purple = 153
let s:gui_yellow = '#ffd52b'
let s:cterm_yellow = 227
let s:gui_red = '#fa8989'
let s:cterm_red = 168
let s:gui_pink = '#f1adff'
let s:cterm_pink = 183
